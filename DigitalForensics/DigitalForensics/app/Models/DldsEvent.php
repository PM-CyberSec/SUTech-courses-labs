...
class DldsEvent extends Model
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'ai_evidence' => is_string($this->ai_evidence) ? json_decode($this->ai_evidence, true) : $this->ai_evidence,
            'model_version' => $this->model_version,
            'correlation_summary' => $this->correlation_summary,
    ...
    /**
     * Backward-compatible alias for older callers. New API/event consumers
     * should use toArray() so the event contract has one canonical shape.
     */
