...
from config import build_http_session, detection_api_timeout, detection_api_url, setup_logging, signed_headers
...
def send_event(description: str) -> bool:
    ...
    try:
        ...
        response = session.post(api_url, data=raw_body, headers=headers, timeout=detection_api_timeout())
