![Typing Effect](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=18&pause=2000&color=00FFCC&background=1E1E1E00&center=false&vCenter=true&width=1000&lines=user%40PM-CyberSec%3A~%24+whoami+--focus+%22Portfolio+Architecture%22+--distro+%22SUTech_Labs%22+--format+%22branch_index%22)

# # SYSTEM_OVERRIDE: [SUTECH_LABS_VAULT]
...
### > Hello, friend.
### > You've accessed the SUTech Lab Vault — a multi-branch portfolio archive.

---

## [ ⟁ ] LOG_01: THE CONCEPT
This repository is not a monorepo. It is a **branch-indexed portfolio vault** where every branch is an independent universe — a complete academic or technical project isolated from the rest.

* $ **ARCHITECTURE=** One branch per project. Zero cross-contamination.
* $ **MASTER_BRANCH_ROLE=** Landing page. Navigation hub. Index only.
* $ **PROJECT_ISOLATION=** Source code lives exclusively on its own branch.
* $ **DESIGN_PATTERN=** Git-as-a-portfolio. Branches as projects.
...
| `DBMS` | Databases | Database management system labs — SQL, schema design, query optimization |
| `DigitalForensics` | Security | AI-assisted network forensics — ML-based anomaly detection on PCAP data |
| `Linux&Shell` | Linux/Shell | Linux administration and shell scripting labs |
| `NetworkOperations` | Networking | Network operations and infrastructure management |
...
| `WebSecurity` | Security | Web application security — OWASP, penetration testing, secure coding |
...
* **Step 02 ->** `git branch -a` *(list all available projects)*
* **Step 03 ->** `git checkout <branch-name>` *(enter a project)*

### Branches with special characters:

> The `Linux&Shell` branch contains an ampersand — **quote the branch name:**

```bash
git checkout "Linux&Shell"
```

To pull the latest state of a specific branch without switching:
...
#### 🛡️ [DIGITAL_FORENSICS] > [BRANCH: DigitalForensics](https://github.com/PM-CyberSec/SUTech-courses-labs/tree/DigitalForensics)
...
> AI-driven network forensics pipeline. Detects C2 exfiltration in PCAP noise using ML classification.

#### 🌐 [ADVANCED_NETWORKS] > [BRANCH: AdvancedNetworks](https://github.com/PM-CyberSec/SUTech-courses-labs/tree/AdvancedNetworks)
...
#### 🖥️ [WEB_SECURITY] > [BRANCH: WebSecurity](https://github.com/PM-CyberSec/SUTech-courses-labs/tree/WebSecurity)
...
> Web application security assessments, secure coding labs, and vulnerability analysis.

#### 📦 [DBMS] > [BRANCH: DBMS](https://github.com/PM-CyberSec/SUTech-courses-labs/tree/DBMS)
...
> Database management system labs covering relational design, normalization, and query tuning.

---

## [ ⚠ ] LOG_02: CAVEATS

* **Each branch is independently versioned** — branches are not synced with master beyond this README.
* **No cross-branch dependencies** exist. Each project stands alone.
* **All work** was conducted in controlled, authorized academic environments.
* **This repository** reflects completed coursework and independent effort.

---

## [ ✉ ] TRANSMIT_DATA
> **Every branch is a story. Read them all.**
